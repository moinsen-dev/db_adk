    ...
    for day in range(1, days + 1):
        ...
        if "sightseeing" in interests or "culture" in interests:
            activities.append(
                {
                    ...
                    "activity": activity_map[
                        "sightseeing" if day % 2 == 1 else "culture"
                    ][day % 3],
                }
            )
        else:
            activities.append(
                {
                    "time": "Morning",
                    "activity": activity_map[interests[0]][
                        day % len(activity_map[interests[0]])
                    ],
                }
            )
        ...
        if "food" in interests:
            activities.append(
                {"time": "Afternoon", "activity": activity_map["food"][day % 3]}
            )
        elif "shopping" in interests:
            activities.append(
                {"time": "Afternoon", "activity": activity_map["shopping"][day % 3]}
            )
        else:
            activities.append(
                {
                    "time": "Afternoon",
                    "activity": activity_map[interests[-1]][
                        day % len(activity_map[interests[-1]])
                    ],
                }
            )
        ...
        # Evening activity
        activities.append(
            {"time": "Evening", "activity": "Enjoy local nightlife and cuisine"}
        )

        # Add day to itinerary
        itinerary["daily_plan"].append({"day": day, "activities": activities})
