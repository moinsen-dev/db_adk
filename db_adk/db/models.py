...
class Agent(Base):
    ...
    agent_type = Column(String(50), nullable=False)  # LLM, Coordinator, Sequential, etc.
...
class Tool(Base):
    ...
    # Relationships
    agents = relationship("Agent", secondary="agent_tools")
...
class AgentRelationship(Base):
    ...
    relationship_type = Column(String(50), nullable=False)  # sequential, orchestrator, etc.
